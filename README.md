...
## Skills and tools
[![My Skills](https://skillicons.dev/icons?i=aws,gcp,linux,git,github,jenkins,kubernetes,docker,ansible,terraform,grafana,prometheus,OWASP,vscode,bash,ubuntu,windows,mysql,html,css)](https://skillicons.dev)

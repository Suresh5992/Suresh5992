...
## Skills and tools
[![My Skills](https://skillicons.dev/icons?i=aws,gcp,linux,git,github,jenkins,kubernetes,docker,ansible,terraform,grafana,prometheus,trivy,owasp,vscode,bash,ubuntu,windows,mysql,html,css)](https://skillicons.dev)
